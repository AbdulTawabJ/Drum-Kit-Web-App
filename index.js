...
switch (butnkey) {
    case "w":
        new Audio("sounds/crash.mp3").play();   anim(butnkey);
        break;
    case "a":
        new Audio("sounds/tom-1.mp3").play();   anim(butnkey);
        break;
    case "s":
        new Audio("sounds/tom-2.mp3").play();   anim(butnkey);
        break;
    case "d":
        new Audio("sounds/tom-3.mp3").play();   anim(butnkey);
        break;
    case "j":
        new Audio("sounds/tom-4.mp3").play();   anim(butnkey);
        break;
    case "k":
        new Audio("sounds/snare.mp3").play();   anim(butnkey);
        break;
    case "l":
        new Audio("sounds/kick-bass.mp3").play();   anim(butnkey);
        break;
